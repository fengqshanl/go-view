...
import { RadarFlockConfig } from './RadarFlock/index'
...
export default [ProcessConfig, RadarConfig, RadarFlockConfig, FunnelConfig, HeatmapConfig, WaterPoloConfig, TreeMapConfig]
