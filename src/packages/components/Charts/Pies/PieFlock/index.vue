<template>
  <div :style="`height:${h}px;width:${w}px;display:flex;flexDirection:row;flex-wrap:wrap;justify-content:left;align-items:center`">
    ...
    <div>
      ...
      <v-chart :theme="themeColor" :option="(chart || default_options)" :manual-update="isPreview()" :style="`position:relative;top:-287px;z-index:15;height:278px;width:262px;margin:auto;`"></v-chart>
...
import { computed, onMounted, PropType, reactive, ref, toRaw, toRefs, watch } from 'vue'
