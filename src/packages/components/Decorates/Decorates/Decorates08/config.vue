<template>
  <CollapseItem name="内容" expanded>
    ...
    <SettingItemBox name="样式">
      ...
      <SettingItem name="大小">
        <n-input-number v-model:value="optionData.textSize" size="small" :min="2"></n-input-number>
      </SettingItem>
      <SettingItem name="竖线宽度">
        <n-input-number v-model:value="optionData.lineWidth" size="small" :min="2"></n-input-number>
      </SettingItem>
    </SettingItemBox>
  </CollapseItem>
