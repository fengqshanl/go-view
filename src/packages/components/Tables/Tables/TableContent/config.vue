<template>
  <CollapseItem name="列表" :expanded="true">
    ...
    <SettingItemBox name="样式">
      <SettingItem name="左侧布块">
        <n-color-picker
          size="small"
          :modes="['hex']"
          v-model:value="optionData.leftColor"
        ></n-color-picker>
      </SettingItem>
          <SettingItem name="右侧布块">
        <n-color-picker
          size="small"
          :modes="['hex']"
          v-model:value="optionData.rightColor"
        ></n-color-picker>
      </SettingItem>
      ...
      <SettingItem name="高度">
        <n-input-number
          size="small"
          v-model:value="optionData.tableRowHeightNumber"
          :min="2"
        />
      </SettingItem>
    </SettingItemBox>
