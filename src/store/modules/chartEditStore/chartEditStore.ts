...
export const useChartEditStore = defineStore({
  ...
  state: (): ChartEditStoreType => ({
    ...
    // 数据请求处理（需存储给后端）
    requestGlobalConfig: {
      requestOriginUrl: baseUrlNoPort,
      ...
      requestParams: {
        ...
        Header: {
          station: "bc858819-c916-3e07-8241-4f6f529d2b0a"
        },
        Params: {
          dept_id: "017330b3-17e7-3c15-8968-32b485ad5463",
          year_id: "08f7c940-9f81-3cb8-a2cd-59da8fe24aaa"
        }
      }
    },
    // 图表数组（需存储给后端）
